...
import (
	...
	"log"
	"net/http"
	"github.com/LeonidezRosado/TamperProof/cookies"
...
func main() {
	...
	//create our server mux instance to handle our http requests
...
func setCookieHandler(w http.ResponseWriter, r *http.Request) {
	...
	//the final argument
	err := cookies.WriteSignature(w, cookie, secretKey)
	if err != nil {
		log.Print(err)
...
func getCookieHandler(w http.ResponseWriter, r *http.Request) {
	 ...
	 //final argument
	 value, err := cookies.ReadSignature(r, "exampleCookie", secretKey)
	 if err != nil {
		switch {
