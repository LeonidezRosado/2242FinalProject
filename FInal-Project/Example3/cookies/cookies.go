...
func WriteSignature(w http.ResponseWriter, cookie http.Cookie, secretKey []byte) error {
...
func ReadSignature(r *http.Request, name string, secretKey []byte) (string, error) {
